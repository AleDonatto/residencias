      ...
      <form action="{{ route('datos_alumnos.store') }}" method="post" class="">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
            ...
            type="text" name="lugar_nacimiento" id="lugar_nacimiento" placeholder="Lugar Nacimiento" onkeypress="return soloLetras(event)" maxlength="50">
          </div>
          ...
          <div class="w-full md:w-1/3 px-3">
            ...
            id="ciudad" placeholder="Ciudad" onkeypress="return soloLetras(event)">
          </div>
          ...
          <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="telefono" name="telefono" type="text" placeholder="Telefono" onkeypress="soloNumeros()" maxlength="10">
          </div>
          ...
          <div class="w-full md:w-1/2 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="codigo_postal" name="codigo_postal" type="text" placeholder="Codigo Postal" onkeypress="soloNumeros()" maxlength="5">
          </div>
        </div>

        <hr class="divide-y divide-blue-300">
        <div class="divide-y divide-blue-300">
          <div class="text-center py-2">Datos Medicos</div>
        </div>
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          <div class="w-full md:w-1/4 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="nombre_madre" name="nombre_madre" type="text" placeholder="Nombre Madre" maxlength="50" onkeypress="return soloLetras(event)">
          </div>
          <div class="w-full md:w-1/4 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="domicilio_madre" name="domicilio_madre" type="text" placeholder="Domicilio" maxlength="50">
          </div>
          <div class="w-full md:w-1/4 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="colonia_madre" name="colonia_madre" type="text" placeholder="Colonia" maxlength="50">
          </div>
          <div class="w-full md:w-1/4 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="telefono_madre" name="telefono_madre" type="text" placeholder="Telefono" maxlength="10" onkeypress="soloNumeros()">
          </div>
          ...
          <div class="w-full md:w-1/4 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="nombre_padre" name="nombre_padre" type="text" placeholder="Nombre Padre" maxlength="50" onkeypress="return soloLetras(event)">
          </div>
          <div class="w-full md:w-1/4 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="domicilio_padre" name="domicilio_padre" type="text" placeholder="Domicilio" maxlength="50">
          </div>
          <div class="w-full md:w-1/4 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="colonia_padre" name="colonia_padre" type="text" placeholder="Colonia" maxlength="50">
          </div>
          <div class="w-full md:w-1/4 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="telefono_padre" name="telefono_padre" type="text" placeholder="Telefono" maxlength="10" onkeypress="soloNumeros()">
          </div>
        </div>
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          <div class="w-full md:w-1/3 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="nombre_contacto" name="nombre_contacto" type="text" placeholder="Contacto de Emergencia" maxlength="50" onkeypress="return soloLetras(event)">
          </div>
          <div class="w-full md:w-1/3 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="telefono_contacto" name="telefono_contacto" type="text" placeholder="Telefono del Contacto" maxlength="10" onkeypress="soloNumeros()">
          </div>
          <div class="w-full md:w-1/3 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="parentesco_contacto" name="parentesco_contacto" type="text" placeholder="Parentesco" maxlength="50" onkeypress="return soloLetras(event)">
          </div>
          ...
          <div class="w-full md:w-1/3 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="nombre_contacto2" name="nombre_contacto2" type="text" placeholder="Contacto de Emergencia 2" maxlength="50" onkeypress="return soloLetras(event)">
          </div>
          <div class="w-full md:w-1/3 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="telefono_contacto2" name="telefono_contacto2" type="text" placeholder="Telefono contacto" maxlength="10" onkeypress="soloNumeros()">
          </div>
          <div class="w-full md:w-1/3 px-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="parentesco_contacto2" name="parentesco_contacto2" type="text" placeholder="Parentesco" maxlength="50" onkeypress="return soloLetras(event)">
          </div>
        </div>
