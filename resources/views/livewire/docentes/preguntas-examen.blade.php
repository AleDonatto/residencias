                    ...
                    <div class="flex items-end">
                        <div class="px-2 w-1/2">
                            <div>
                                ...
                                <input type="text" wire:model.defer="preguntaEdit" name="puntosPreguntaEdit" id="puntosPreguntaEdit" class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                                maxlength="100">
