        ...
        <form wire:submit.prevent="update">
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <x-jet-input id="lugar_nacimiento"  type="text" class="mt-1 block w-full" wire:model.defer="lugarNac" onkeypress="return soloLetras(event)"
                    maxlength="50"/>
                ...
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <x-jet-input id="fecha_nacimiento"  type="date" class="mt-1 block w-full" wire:model.defer="fechaNac" />
